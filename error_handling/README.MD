...
![error_Handling](../assets/images/error-handling.png)
...
A partir do código acima, podemos ver que scannerao operar a E/S subjacente, não há case *if err !=nil* e há uma *scanner.Err()*
